...
import com.example.appbanhang.Database.HoaDonDAO;
import com.example.appbanhang.ListHoaDonActivity;
...
//
//    public HoaDonAdapter(ListHoaDonActivity context, List<HoaDon> dsHoaDon) {
//
//    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.img.setImageResource(R.drawable.hoadon);
    ...
    public Filter getFilter() {
        if (hoaDonFilter == null) hoaDonFilter = new CustomFilter();
        return hoaDonFilter;
    }
